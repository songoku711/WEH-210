...
static tFsmGuard MenuManager_FwdRunSpeed_Entry                        (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_FwdRunSpeed_Exit                         (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_FwdRunSpeed_Submenu1                     (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_FwdRunSpeed_StartBut                     (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_FwdRunSpeed_StopBut                      (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_FwdRunSpeed_UpBut                        (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_FwdRunSpeed_DownBut                      (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_FwdRunSpeed_StateMachine[7] =
{
  FSM_TRIGGER_ENTRY             (                                     MenuManager_FwdRunSpeed_Entry                                                   ),
  FSM_TRIGGER_EXIT              (                                     MenuManager_FwdRunSpeed_Exit                                                    ),
  FSM_TRIGGER_TRANSITION_ACTION ( MENUMANAGER_EVENT_SUBMENU_1,        MenuManager_FwdRunSpeed_Submenu1,       MENUMANAGER_STATE_EXTRACT_SETUP         ),
