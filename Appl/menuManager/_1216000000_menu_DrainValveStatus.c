...
static tFsmGuard MenuManager_DrainValveStatus_Entry                   (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_DrainValveStatus_Exit                    (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_DrainValveStatus_Submenu1                (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_DrainValveStatus_StartBut                (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_DrainValveStatus_StopBut                 (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_DrainValveStatus_UpBut                   (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_DrainValveStatus_DownBut                 (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_DrainValveStatus_StateMachine[7] =
{
  FSM_TRIGGER_ENTRY             (                                     MenuManager_DrainValveStatus_Entry                                              ),
  FSM_TRIGGER_EXIT              (                                     MenuManager_DrainValveStatus_Exit                                               ),
  FSM_TRIGGER_TRANSITION_ACTION ( MENUMANAGER_EVENT_SUBMENU_1,        MenuManager_DrainValveStatus_Submenu1,  MENUMANAGER_STATE_MACHINE_FUNC_SETUP    ),
