...
static Fsm_GuardType MenuManager_UnlockDoorLevel_Submenu1                 (Fsm_ContextStructPtr const pFsmContext, Fsm_EventType event);
...
Fsm_EventEntryStruct MenuManager_UnlockDoorLevel_StateMachine[9] =
{
  ...
  FSM_TRIGGER_TRANSITION_ACTION ( MENUMANAGER_EVENT_SUBMENU_1,        MenuManager_UnlockDoorLevel_Submenu1,   MENUMANAGER_STATE_DOOR_LOCK_SETUP       ),
