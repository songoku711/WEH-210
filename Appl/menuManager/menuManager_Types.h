    ...
    MENUMANAGER_STATE_MAIN_SETTING,
      ...
      MENUMANAGER_STATE_MACHINE_SETUP,
        MENUMANAGER_STATE_MACHINE_FUNC_SETUP,
          ...
          MENUMANAGER_STATE_WASH_MACHINE,
        ...
        MENUMANAGER_STATE_FILL_LEVEL_SETUP,
          ...
          MENUMANAGER_STATE_SOAP_START_LEVEL,
        ...
        MENUMANAGER_STATE_WASH_SETUP,
          MENUMANAGER_STATE_STD_WASH_RUN_TIME,
          MENUMANAGER_STATE_STD_WASH_STOP_TIME,
          MENUMANAGER_STATE_DEL_WASH_RUN_TIME,
          MENUMANAGER_STATE_DEL_WASH_STOP_TIME,
          MENUMANAGER_STATE_HVY_WASH_RUN_TIME,
          MENUMANAGER_STATE_HVY_WASH_STOP_TIME,
          MENUMANAGER_STATE_STD_WASH_SPEED,
          MENUMANAGER_STATE_DEL_WASH_SPEED,
          MENUMANAGER_STATE_HVY_WASH_SPEED,
        MENUMANAGER_STATE_DRAIN_SETUP,
          MENUMANAGER_STATE_DRAIN_SETUP_PARAM,
            MENUMANAGER_STATE_DRAIN_SETUP_TIME,
            MENUMANAGER_STATE_DRAIN_SETUP_SPEED,
          MENUMANAGER_STATE_DRAIN_OFF_TIME,
          MENUMANAGER_STATE_MAX_DRAIN_EXTRACT_TIME,
          MENUMANAGER_STATE_REDRAIN_EXTRACT_TIME,
          MENUMANAGER_STATE_MAX_DRAIN_EXTRACT_SPEED,
        MENUMANAGER_STATE_DOOR_LOCK_SETUP,
          MENUMANAGER_STATE_USE_LOCK_STOP_BUTTON,
          MENUMANAGER_STATE_DOOR_LOCK_VALVE_STATUS,
          MENUMANAGER_STATE_UNLOCK_DOOR_TEMP,
          MENUMANAGER_STATE_UNLOCK_DOOR_LEVEL,
      MENUMANAGER_STATE_PROGRAM_SETUP,
        MENUMANAGER_STATE_PROGRAM_STEP_SETUP,
          MENUMANAGER_STATE_STEP_NORM_SETUP,
            MENUMANAGER_STATE_STEP_IS_ACTIVE,
            MENUMANAGER_STATE_STEP_WATER_MODE,
            MENUMANAGER_STATE_STEP_SOAP_MODE,
            MENUMANAGER_STATE_STEP_WASH_MODE,
              MENUMANAGER_STATE_STEP_WASH_MODE_CUSTOM,
                MENUMANAGER_STATE_STEP_WASH_RUN_TIME,
                MENUMANAGER_STATE_STEP_WASH_STOP_TIME,
                MENUMANAGER_STATE_STEP_WASH_SPEED,
            MENUMANAGER_STATE_STEP_WASH_TIME,
            MENUMANAGER_STATE_STEP_TEMP_MODE,
              MENUMANAGER_STATE_STEP_TEMP_MODE_CUSTOM,
            MENUMANAGER_STATE_STEP_LEVEL_MODE,
              MENUMANAGER_STATE_STEP_LEVEL_MODE_CUSTOM,
            MENUMANAGER_STATE_STEP_DRAIN_MODE,
              MENUMANAGER_STATE_STEP_DRAIN_MODE_CUSTOM,
                MENUMANAGER_STATE_STEP_DRAIN_MODE_PARAM,
                  MENUMANAGER_STATE_STEP_DRAIN_MODE_TIME,
                  MENUMANAGER_STATE_STEP_DRAIN_MODE_SPEED,
...
typedef enum
{
  MENUMANAGER_EVENT_PREV = FSM_DEFAULTEVENT_NUM,
  ...
  MENUMANAGER_EVENT_SUBMENU_11,
  MENUMANAGER_EVENT_SUBMENU_12,
  MENUMANAGER_EVENT_SUBMENU_13,
  MENUMANAGER_EVENT_SUBMENU_14,
  MENUMANAGER_EVENT_SUBMENU_15,
  MENUMANAGER_EVENT_SUBMENU_16,
  MENUMANAGER_EVENT_SUBMENU_17,
  MENUMANAGER_EVENT_SUBMENU_18,
  MENUMANAGER_EVENT_SUBMENU_19,
  MENUMANAGER_EVENT_SUBMENU_20,
  MENUMANAGER_EVENT_SUBMENU_21,
  MENUMANAGER_EVENT_SUBMENU_22,
  MENUMANAGER_EVENT_SUBMENU_23
