...
static tFsmGuard MenuManager_StdWashStopTime_Entry                    (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_StdWashStopTime_Exit                     (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_StdWashStopTime_Submenu1                 (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_StdWashStopTime_StartBut                 (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_StdWashStopTime_StopBut                  (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_StdWashStopTime_UpBut                    (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_StdWashStopTime_DownBut                  (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_StdWashStopTime_AddBut                   (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_StdWashStopTime_SubBut                   (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_StdWashStopTime_StateMachine[9] =
{
  FSM_TRIGGER_ENTRY             (                                     MenuManager_StdWashStopTime_Entry                                               ),
  FSM_TRIGGER_EXIT              (                                     MenuManager_StdWashStopTime_Exit                                                ),
  FSM_TRIGGER_TRANSITION_ACTION ( MENUMANAGER_EVENT_SUBMENU_1,        MenuManager_StdWashStopTime_Submenu1,   MENUMANAGER_STATE_WASH_SETUP            ),
