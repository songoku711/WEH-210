...
static tFsmGuard MenuManager_ExtractShock_Entry                       (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_ExtractShock_Exit                        (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_ExtractShock_Submenu1                    (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_ExtractShock_StartBut                    (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_ExtractShock_StopBut                     (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_ExtractShock_UpBut                       (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_ExtractShock_DownBut                     (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_ExtractShock_StateMachine[7] =
{
