...
void EXTI2_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(BUT_ADD_Pin);
...
void EXTI4_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(BUT_SUB_Pin);
...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(BUT_EXTRACT_Pin);
  HAL_GPIO_EXTI_IRQHandler(BUT_WASH_Pin);
  HAL_GPIO_EXTI_IRQHandler(BUT_DRAIN_Pin);
  HAL_GPIO_EXTI_IRQHandler(BUT_COLD_Pin);
...
void TIM1_UP_TIM10_IRQHandler(void)
{
  ...
  if (__HAL_TIM_GET_FLAG(&htim10, TIM_FLAG_UPDATE) != RESET)
  {
    if (__HAL_TIM_GET_IT_SOURCE(&htim10, TIM_IT_UPDATE) != RESET)
    {
      ...
      htim10.PeriodElapsedCallback(&htim10);
    }
  }
...
void EXTI15_10_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(BUT_SUPP_3_Pin);
  HAL_GPIO_EXTI_IRQHandler(BUT_HOT_Pin);
  HAL_GPIO_EXTI_IRQHandler(BUT_SUPP_2_Pin);
  HAL_GPIO_EXTI_IRQHandler(BUT_HEAT_Pin);
  HAL_GPIO_EXTI_IRQHandler(BUT_SUPP_1_Pin);
  HAL_GPIO_EXTI_IRQHandler(BUT_LEVEL_Pin);
