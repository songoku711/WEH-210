...
/* Number of buttons */
#define IOMANAGER_BUTTON_NUM                              (16U)
...
static IoManager_ButtonConfStruct IoManager_buttonCfg[IOMANAGER_BUTTON_NUM] =
{
  ...
  { BUT_ADD_GPIO_Port,       BUT_ADD_Pin,       (uint32_t)IOMANAGER_BUTTON_STATE_ADD,       (uint32_t)(IOMANAGER_BUTTON_PRESS_SHORT) },
  { BUT_UP_GPIO_Port,        BUT_UP_Pin,        (uint32_t)IOMANAGER_BUTTON_STATE_UP,        (uint32_t)(IOMANAGER_BUTTON_PRESS_SHORT) },
  { BUT_SUB_GPIO_Port,       BUT_SUB_Pin,       (uint32_t)IOMANAGER_BUTTON_STATE_SUB,       (uint32_t)(IOMANAGER_BUTTON_PRESS_SHORT) },
  ...
  { BUT_COLD_GPIO_Port,      BUT_COLD_Pin,      (uint32_t)IOMANAGER_BUTTON_STATE_COLD,      (uint32_t)(IOMANAGER_BUTTON_PRESS_SHORT) },
  { BUT_SUPP_3_GPIO_Port,    BUT_SUPP_3_Pin,    (uint32_t)IOMANAGER_BUTTON_STATE_SUPP3,     (uint32_t)(IOMANAGER_BUTTON_PRESS_SHORT) },
  { BUT_HOT_GPIO_Port,       BUT_HOT_Pin,       (uint32_t)IOMANAGER_BUTTON_STATE_HOT,       (uint32_t)(IOMANAGER_BUTTON_PRESS_SHORT) },
  { BUT_SUPP_2_GPIO_Port,    BUT_SUPP_2_Pin,    (uint32_t)IOMANAGER_BUTTON_STATE_SUPP2,     (uint32_t)(IOMANAGER_BUTTON_PRESS_SHORT) },
  { BUT_HEAT_GPIO_Port,      BUT_HEAT_Pin,      (uint32_t)IOMANAGER_BUTTON_STATE_HEAT,      (uint32_t)(IOMANAGER_BUTTON_PRESS_SHORT) },
  { BUT_SUPP_1_GPIO_Port,    BUT_SUPP_1_Pin,    (uint32_t)IOMANAGER_BUTTON_STATE_SUPP1,     (uint32_t)(IOMANAGER_BUTTON_PRESS_SHORT) },
  { BUT_LEVEL_GPIO_Port,     BUT_LEVEL_Pin,     (uint32_t)IOMANAGER_BUTTON_STATE_LEVEL,     (uint32_t)(IOMANAGER_BUTTON_PRESS_SHORT) }
};
