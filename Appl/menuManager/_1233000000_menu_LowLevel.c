...
static tFsmGuard MenuManager_LowLevel_Entry                           (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LowLevel_Exit                            (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LowLevel_Submenu1                        (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LowLevel_StartBut                        (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LowLevel_StopBut                         (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LowLevel_UpBut                           (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LowLevel_DownBut                         (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LowLevel_AddBut                          (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LowLevel_SubBut                          (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_LowLevel_StateMachine[9] =
{
