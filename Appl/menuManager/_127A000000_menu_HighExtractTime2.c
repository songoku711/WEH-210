...
static tFsmGuard MenuManager_HighExtractTime2_Entry                   (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractTime2_Exit                    (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractTime2_Submenu1                (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractTime2_StartBut                (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractTime2_StopBut                 (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractTime2_UpBut                   (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractTime2_DownBut                 (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractTime2_AddBut                  (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractTime2_SubBut                  (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_HighExtractTime2_StateMachine[9] =
{
  FSM_TRIGGER_ENTRY             (                                     MenuManager_HighExtractTime2_Entry                                              ),
  FSM_TRIGGER_EXIT              (                                     MenuManager_HighExtractTime2_Exit                                               ),
  FSM_TRIGGER_TRANSITION_ACTION ( MENUMANAGER_EVENT_SUBMENU_1,        MenuManager_HighExtractTime2_Submenu1,  MENUMANAGER_STATE_EXTRACT_SETUP         ),
