    ...
    MENUMANAGER_STATE_MAIN_SETTING,
      ...
      MENUMANAGER_STATE_MACHINE_SETUP,
        ...
        MENUMANAGER_STATE_SOAP_SETUP,
          MENUMANAGER_STATE_STOP_FILL_WHEN_SOAP,
          MENUMANAGER_STATE_TIME_SOAP_1,
          MENUMANAGER_STATE_TIME_SOAP_2,
          MENUMANAGER_STATE_TIME_SOAP_3,
        MENUMANAGER_STATE_WASH_SETUP,
          MENUMANAGER_STATE_MIN_PAUSE_FWD_REV,
          ...
          MENUMANAGER_STATE_MAX_WASH_SPEED,
