...
static tFsmGuard MenuManager_AutoRefillWhenLow_Entry                  (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_AutoRefillWhenLow_Exit                   (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_AutoRefillWhenLow_Submenu1               (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_AutoRefillWhenLow_StartBut               (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_AutoRefillWhenLow_StopBut                (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_AutoRefillWhenLow_UpBut                  (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_AutoRefillWhenLow_DownBut                (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_AutoRefillWhenLow_StateMachine[7] =
{
