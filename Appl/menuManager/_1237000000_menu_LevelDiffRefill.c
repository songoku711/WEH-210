...
static tFsmGuard MenuManager_LevelDiffRefill_Entry                    (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LevelDiffRefill_Exit                     (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LevelDiffRefill_Submenu1                 (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LevelDiffRefill_StartBut                 (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LevelDiffRefill_StopBut                  (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LevelDiffRefill_UpBut                    (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LevelDiffRefill_DownBut                  (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LevelDiffRefill_AddBut                   (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_LevelDiffRefill_SubBut                   (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_LevelDiffRefill_StateMachine[9] =
{
  FSM_TRIGGER_ENTRY             (                                     MenuManager_LevelDiffRefill_Entry                                               ),
  FSM_TRIGGER_EXIT              (                                     MenuManager_LevelDiffRefill_Exit                                                ),
  FSM_TRIGGER_TRANSITION_ACTION ( MENUMANAGER_EVENT_SUBMENU_1,        MenuManager_LevelDiffRefill_Submenu1,   MENUMANAGER_STATE_FILL_LEVEL_SETUP      ),
