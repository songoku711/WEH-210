...
static tFsmGuard MenuManager_EmergencyStop_Entry                      (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_EmergencyStop_Exit                       (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_EmergencyStop_Submenu1                   (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_EmergencyStop_StartBut                   (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_EmergencyStop_StopBut                    (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_EmergencyStop_UpBut                      (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_EmergencyStop_DownBut                    (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_EmergencyStop_StateMachine[7] =
{
  FSM_TRIGGER_ENTRY             (                                     MenuManager_EmergencyStop_Entry                                                 ),
  FSM_TRIGGER_EXIT              (                                     MenuManager_EmergencyStop_Exit                                                  ),
  FSM_TRIGGER_TRANSITION_ACTION ( MENUMANAGER_EVENT_SUBMENU_1,        MenuManager_EmergencyStop_Submenu1,     MENUMANAGER_STATE_INPUT_STATUS_SETUP    ),
