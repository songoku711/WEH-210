...
static tFsmGuard MenuManager_HighExtractSpeed1_Entry                  (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractSpeed1_Exit                   (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractSpeed1_Submenu1               (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractSpeed1_StartBut               (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractSpeed1_StopBut                (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractSpeed1_UpBut                  (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_HighExtractSpeed1_DownBut                (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_HighExtractSpeed1_StateMachine[7] =
{
  FSM_TRIGGER_ENTRY             (                                     MenuManager_HighExtractSpeed1_Entry                                             ),
  FSM_TRIGGER_EXIT              (                                     MenuManager_HighExtractSpeed1_Exit                                              ),
  FSM_TRIGGER_TRANSITION_ACTION ( MENUMANAGER_EVENT_SUBMENU_1,        MenuManager_HighExtractSpeed1_Submenu1, MENUMANAGER_STATE_EXTRACT_SETUP         ),
