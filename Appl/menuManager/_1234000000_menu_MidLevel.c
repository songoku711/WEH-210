...
static tFsmGuard MenuManager_MidLevel_Entry                           (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_MidLevel_Exit                            (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_MidLevel_Submenu1                        (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_MidLevel_StartBut                        (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_MidLevel_StopBut                         (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_MidLevel_UpBut                           (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_MidLevel_DownBut                         (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_MidLevel_AddBut                          (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_MidLevel_SubBut                          (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_MidLevel_StateMachine[9] =
{
  FSM_TRIGGER_ENTRY             (                                     MenuManager_MidLevel_Entry                                                      ),
  FSM_TRIGGER_EXIT              (                                     MenuManager_MidLevel_Exit                                                       ),
  FSM_TRIGGER_TRANSITION_ACTION ( MENUMANAGER_EVENT_SUBMENU_1,        MenuManager_MidLevel_Submenu1,          MENUMANAGER_STATE_FILL_LEVEL_SETUP      ),
