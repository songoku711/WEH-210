...
static tFsmGuard MenuManager_TimeSoap2_Entry                          (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_TimeSoap2_Exit                           (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_TimeSoap2_Submenu1                       (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_TimeSoap2_StartBut                       (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_TimeSoap2_StopBut                        (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_TimeSoap2_UpBut                          (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_TimeSoap2_DownBut                        (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_TimeSoap2_AddBut                         (tFsmContextPtr const pFsmContext, tFsmEvent event);
static tFsmGuard MenuManager_TimeSoap2_SubBut                         (tFsmContextPtr const pFsmContext, tFsmEvent event);

/** Menu manager state machine */
tFsmEventEntry MenuManager_TimeSoap2_StateMachine[9] =
{
...
static void MenuManager_TimeSoap2_SubMainFunction(void)
{
  ...
  switch (MenuManager_TimeSoap2_InternalState)
  {
    ...
    case MENUMANAGER_TIMESOAP2_INTERNALSTATE_RUNNING:
    {
      ...
      tempTimeSoap2 = (uint8_t)MenuManager_TimeSoap2_Value;
